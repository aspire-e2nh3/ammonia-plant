...
while (stop == 0):
    ...
    print('Bed 1 length = %2.1fm, conversion = %2.2f' % (bed1.vect[-1], Bed_iterator.NH3/(2*Pipe_1c.N2)*100) + '%' + ', T = %3.1f' % Bed_iterator.T + 'K')
    ...
    [Pipe_4b, Pipe_2b_fake, HTHE_DelT_new] = heat_exchanger_hotgas2coldgas(Pipe_2a, Pipe_1b)
    ...
    print('Triple cooled chiller outlet T = %3.1f' % Pipe_2c.T)

    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~ Condensor ~~~~~~~~~~~~~~~~~~~~~~~~~~~
    [Pipe_recycle, power_consumption["Condensor"]] = condensor(Pipe_2c, e2=0.9, water_mass_flow=10)
